...
class TestAdvertisement(Advertisement):
    ...
    def __init__(self, bus, index):
        ...
        self.add_service_uuid('019350af-95b4-726b-b8e4-62b642524ebe')
        # self.add_service_uuid('019350aa-46c7-7520-ab0c-90fb45bc0c03')
        # self.add_manufacturer_data(0xffff, [0x00, 0x01, 0x02, 0x03])
        # self.add_service_data('9999', [0x00, 0x01, 0x02, 0x03, 0x04])
        self.add_local_name('RingRing Phone')
